...
My research is primarily in optimization—both theory and application—and often both simultaneously. I have been developing methodologies that automate the **[construction of provably fastest algorithms](https://shuvomoy.github.io/Papers/Das_Gupta_et_al_BnB_PEP.pdf)** for classes of optimization problems, including many of those arising in machine learning, business analytics, and data science more broadly. These methodologies formulate algorithm design and analysis as solvable optimization problems in and of themselves and have led to several significant and impactful applications, such as **[discovering optimal algorithms](https://arxiv.org/abs/2305.15704)** and **[constructing novel mathematical proofs](https://arxiv.org/pdf/2301.01530.pdf)**. Very recently, my methodologies helped pave the way for **novel accelerated gradient descent methods** by other researchers (see [[Link 1](https://arxiv.org/pdf/2309.07879.pdf)], [[Link 2](https://arxiv.org/abs/2309.09961)], [[media coverage](https://www.quantamagazine.org/risky-giant-steps-can-solve-optimization-problems-faster-20230811/)]). In addition to my research in theory and computational tools in optimization, I have been working on developing **[sustainable transportation systems](https://arxiv.org/pdf/2309.05489.pdf)**. My research in this area has been [implemented](https://shuvomoy.github.io/Papers/A_two_step_linear_programming_model_for_energy_efficient_timetables_in_metro_railway_networks.pdf) in the largest installed base of communication-based train control systems worldwide and has been deployed in major cities around the world, including London, Hong Kong, Shanghai, New York, and Vancouver.
...
- **Shuvomoy Das Gupta**, [Bartolomeo Stellato](https://stellato.io/), and Bart P.G. Van Parys, “[Exterior-point Optimization for Sparse and Low-rank Optimization](https://arxiv.org/abs/2011.04552)”, major revision in the  *Journal of Optimization Theory and Applications*, 2023. [[pdf](https://arxiv.org/abs/2011.04552)] [[NExOS.jl Julia package](https://github.com/Shuvomoy/NExOS.jl)] [[INFORMS 2020 Presentation](/assets/Sozi_presentations/INFORMS_Annual_Meeting_2020_presentation.html)] [[bib](assets/bibtex_citations/NExOS.bib)]

* **Shuvomoy Das Gupta**, Bart P.G. Van Parys, and J. Kevin Tobin, “[Energy-optimal Timetable Design for Sustainable Metro Railway Networks](https://arxiv.org/abs/2309.05489)”, under review in *Transportation Research Part B: Methodological*, 2023. [[pdf](https://arxiv.org/pdf/2309.05489.pdf)] [[slides](/assets/slides/Transport_2023.html)] [[poster](https://shuvomoy.github.io/Papers/MITEI_conference_2023_final_poster.pdf)] [[bib](assets/bibtex_citations/CBTC2023.bib)] 
